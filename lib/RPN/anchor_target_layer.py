...
def anchor_target_layer(rpn_cls_score, gt_boxes, im_dims, feat_stride, anchor_scales):
    '''
...
def _anchor_target_layer_py(rpn_cls_score, gt_boxes, im_dims, feat_stride, anchor_scales):
    """
    Python version
